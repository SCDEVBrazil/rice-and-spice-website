...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] flex items-center">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Rice and Spice Restaurant Interior"
            fill
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
          <div className="text-center space-y-6 md:space-y-8">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-decorative text-cream leading-tight px-4">
              Authentic Indian Cuisine in Peoria
            </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 text-cream">
                ...
                <div className="flex flex-col items-center space-y-2 p-4 bg-black/20 rounded-lg backdrop-blur-sm">
                  <div className="flex items-center space-x-2">
                    <MapPin className="h-5 w-5 md:h-6 md:w-6 text-gold flex-shrink-0" />
                ...
                <div className="flex flex-col items-center space-y-2 p-4 bg-black/20 rounded-lg backdrop-blur-sm">
                  <div className="flex items-center space-x-2">
                    <Phone className="h-5 w-5 md:h-6 md:w-6 text-gold flex-shrink-0" />
                ...
                <div className="flex flex-col items-center space-y-2 p-4 bg-black/20 rounded-lg backdrop-blur-sm">
                  <div className="flex items-center space-x-2">
                    <Clock className="h-5 w-5 md:h-6 md:w-6 text-gold flex-shrink-0" />
      ...
      <div className="bg-gradient-to-br from-amber-900 to-black">
        ...
        <div className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            {/* Header */}
            <div className="mb-8">
              <h2 className="text-3xl md:text-4xl font-serif text-yellow-400 mb-4 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                Welcome to {loading ? (
            ...
            {/* Updated Feature Cards with Better Icons */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              {/* Authentic Recipes Card */}
              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                ...
                <p className="text-amber-100">Traditional family recipes passed down through generations, bringing you the true taste of India.</p>
              </div>
              ...
              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                ...
                <p className="text-amber-100">We source the finest spices and freshest ingredients to ensure every dish bursts with flavor.</p>
              </div>
              ...
              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                ...
                <p className="text-amber-100">Our skilled chefs bring years of experience from various regions of India to your plate.</p>
              </div>
            </div>
            ...
            <div className="mt-12">
              <p className="text-lg text-amber-100 mb-8">
                Come taste the difference that authentic Indian cooking makes.
              </p>
        ...
        <div className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8">
              ...
              <h3 className="text-4xl md:text-5xl text-yellow-400 mb-4 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), cursive', textShadow: '3px 3px 6px rgba(0,0,0,0.7)', letterSpacing: '0.08em', fontWeight: '700' }}>
                All You Can Eat
              </h3>
              <p className="text-2xl font-bold text-orange-400 mb-3">Every Saturday</p>
            ...
            {/* Featured Dishes */}
            <div className="bg-yellow-900/40 backdrop-blur-sm rounded-lg p-8 border-2 border-yellow-600/50 shadow-2xl">
              <p className="text-lg text-orange-300 mb-4 font-medium">Featured dishes include:</p>
              <p className="text-xl text-amber-100 leading-relaxed">
                Chicken Tikka Masala • Biryani • Dal • Naan <br/>
                Samosas • Tandoori Chicken • Paneer Dishes <br/>
                <span className="font-bold text-yellow-400 text-2xl">and much more!</span>
              </p>
        ...
        {/* Indian Tadka Section */}
        <div className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-serif text-yellow-400 mb-2 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                Visit Our Sister Restaurant
              </h2>
              <div className="h-1 w-40 bg-yellow-500 mx-auto"></div>
            </div>

            <div className="bg-yellow-900/40 backdrop-blur-sm rounded-lg shadow-2xl overflow-hidden border-2 border-yellow-600/50">
              <div className="flex flex-col md:flex-row min-h-[500px]">
                <div className="md:w-1/2 p-8 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="bg-orange-700 inline-block px-4 py-2 rounded text-yellow-400 font-bold mb-2 text-center border border-yellow-600">
                      Open Sundays!
                    </div>
                    <div className="bg-yellow-600 inline-block px-4 py-2 rounded text-amber-900 font-bold mb-6 text-center ml-2 border border-orange-600">
                      Sunday Lunch Buffet
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 flex-grow">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-amber-100">(309) 598-2024</p>
                    </div>
                    <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-3 mt-6">
                    <div className="flex items-start gap-3">
                      <svg className="h-5 w-5 text-yellow-400 mt-1" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
                      </svg>
                      <Link
        ...
        <div className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <div className="h-1 w-32 bg-yellow-500 mx-auto mb-6"></div>
              <p className="text-lg text-amber-100">
                From intimate gatherings to large celebrations, we offer catering and private event spaces.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                <div className="bg-yellow-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Utensils className="h-8 w-8 text-amber-900" />
                </div>
                <h3 className="text-xl font-bold text-yellow-400 mb-3 text-center">Catering</h3>
                <p className="text-amber-100 text-center">
                  Bring the flavors of Rice and Spice to your location with our catering services.
                </p>
              </div>
              ...
              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-yellow-400 mb-3 text-center">Private Dining</h3>
                <p className="text-amber-100 text-center">Reserve our elegant private dining room for your special occasions.</p>
              </div>

              <div className="bg-yellow-900/50 backdrop-blur-sm rounded-lg p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border-2 border-yellow-600/50 transform hover:-translate-y-1">
                <div className="bg-yellow-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <CalendarDays className="h-8 w-8 text-amber-900" />
                </div>
                <h3 className="text-xl font-bold text-yellow-400 mb-3 text-center">Celebrations</h3>
                <p className="text-amber-100 text-center">
                  Make your celebrations memorable with our festive atmosphere and delicious food.
                </p>
              </div>
            </div>
